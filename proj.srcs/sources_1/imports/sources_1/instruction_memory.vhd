...
--            var_insn_mem(15) := X"100e"; -- beq $0 $0 -2 ; infinite loop
            ...
            var_insn_mem(3) := "10011100110001100000000011110000"; -- ori $6, $0, 240             # imm = 0xF0
            ...
            var_insn_mem(6) := "10011100111001110000111100000000"; -- ori $7, $0, 3840            # imm = 0xF00
            ...
            var_insn_mem(9) := "10011101000010001110111111011000"; -- ori $8, $0, 61400           # imm = 0xF000
            ...
            var_insn_mem(13) := "10011101010010100000000000001111"; -- ori $10, $0, 15             # imm = 0xF
            ...
            var_insn_mem(16) := "10011101001010010000000000000110"; -- ori $9, $0, 6               # imm = 0b0110
            ...
            var_insn_mem(22) := "10011101011010110000000000001001"; -- ori $11, $0, 9              # imm = 0b1001
            var_insn_mem(23) := "10010000111010110011100000000000"; -- and $7, $7, $11
            var_insn_mem(24) := "10010100111010100011100000000000"; -- or $7, $7, $10
            var_insn_mem(25) := "10111100000010110000000000000000"; -- lui $11, 0
            var_insn_mem(26) := "10011101011010110000000000000011"; -- ori $11, $0, 3              # imm = 0b0011
            var_insn_mem(27) := "10010000110010110011000000000000"; -- and $6, $6, $11
            var_insn_mem(28) := "10010100110010010011000000000000"; -- or $6, $6, $9
            var_insn_mem(29) := "10111100000010100000000000000000"; -- lui $10, 0
            var_insn_mem(30) := "10011101010010100000000000001100"; -- ori $10, $0, 12             # imm = 0b1100
            ...
            var_insn_mem(33) := "10010101001010000100000000000000"; -- or $8, $9, $8
            var_insn_mem(34) := "10011000110001110011000000000000"; -- xor $6, $6, $7
            var_insn_mem(35) := "10011000110010000011000000000000"; -- xor $6, $6, $8
            var_insn_mem(36) := "10111100000010010000000000000000"; -- lui $9, 0
            var_insn_mem(37) := "10011101001010010000000000001111"; -- ori $9, $0, 15              # imm = 0xF
            var_insn_mem(38) := "10010000101010010011100000000000"; -- and $7, $5, $9              # record tag
            var_insn_mem(39) := "10010100111000000100101000000001"; -- or $9, $7, $0, lsl 8
            var_insn_mem(40) := "10010101001001100100100000000000"; -- or $9, $9, $6
            var_insn_mem(41) := "01110001001000000000000000000000"; -- dispr $9
            var_insn_mem(42) := "00010000110001110000000000000001"; -- beq $6, $7, 1
            var_insn_mem(43) := "00010000000000000000000000001101"; -- beq $0, $0, 13
            var_insn_mem(44) := "10111100000010010000000000000000"; -- lui $9, 0
            var_insn_mem(45) := "10011101001010010000111111110000"; -- ori $9, $0, 4080            # imm = 0xFF0
            var_insn_mem(46) := "10010000101010010100000100000000"; -- and $8, $5, $9, lsr 4       # record tally
            var_insn_mem(47) := "10111100000010010000000000000000"; -- lui $9, 0
            var_insn_mem(48) := "10011101001010010011000000000000"; -- ori $9, $0, 12288           # imm = 0x3000
            var_insn_mem(49) := "10010000101010010100101100000000"; -- and $9, $5, $9, lsr 12      # record candidate ID
            var_insn_mem(50) := "11100001001010100000000000000000"; -- lw $10, $9(0)
            var_insn_mem(51) := "10000001010010000101000000000000"; -- add $10, $10, $8
            var_insn_mem(52) := "01000001001010100000000000000000"; -- sw $10, $9(0)
            var_insn_mem(53) := "11100000000000010000000000000000"; -- lw $1, $0(0)
            var_insn_mem(54) := "11100000000000100000000000000001"; -- lw $2, $0(1)
            var_insn_mem(55) := "11100000000000110000000000000010"; -- lw $3, $0(2)
            var_insn_mem(56) := "11100000000001000000000000000011"; -- lw $4, $0(3)
            var_insn_mem(57) := "00010000000000000000000011000110"; -- beq $0, $0, 198
