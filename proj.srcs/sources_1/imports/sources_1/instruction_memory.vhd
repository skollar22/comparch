...
--            var_insn_mem(15) := X"100e"; -- beq $0 $0 -2 ; infinite loop
            ...
            var_insn_mem(36) := "11100001001010100000000000001001"; -- lw $10, $9(0)
            var_insn_mem(37) := "10000001010010000101000000000000"; -- add $10, $10, $8
            var_insn_mem(38) := "01000001001010100000000000001001"; -- sw $10, $9(0)
            var_insn_mem(39) := "11100000000000010000000000000000"; -- lw $1, $0(0)
            var_insn_mem(40) := "11100000000000100000000000000000"; -- lw $2, $0(1)
            var_insn_mem(41) := "11100000000000110000000000000000"; -- lw $3, $0(2)
            var_insn_mem(42) := "11100000000001000000000000000000"; -- lw $4, $0(3)
