...
--            var_insn_mem(15) := X"100e"; -- beq $0 $0 -2 ; infinite loop
            ...
            var_insn_mem(9) := "10011100000010001110111111011000"; -- ori $8, $0, 61400           # imm = 0xF000
            ...
            var_insn_mem(22) := "10011100000010110000000000001001"; -- ori $11, $0, 9              # imm = 0b1001
            ...
            var_insn_mem(26) := "10011100000010110000000000000011"; -- ori $11, $0, 3              # imm = 0b0011
            ...
            var_insn_mem(37) := "10011100000010010000000000001111"; -- ori $9, $0, 15              # imm = 0xF
            ...
            var_insn_mem(42) := "00010000111001100000000000000001"; -- beq $6, $7, 1
            var_insn_mem(43) := "00010000000000000000000000001101"; -- beq $0, $0, 13
            var_insn_mem(44) := "10111100000010010000000000000000"; -- lui $9, 0
            var_insn_mem(45) := "10011100000010010000111111110000"; -- ori $9, $0, 4080            # imm = 0xFF0
            ...
            var_insn_mem(48) := "10011100000010010011000000000000"; -- ori $9, $0, 12288           # imm = 0x3000
