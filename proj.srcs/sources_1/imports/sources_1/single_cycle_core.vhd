...
component hazard_unit is
  ...
  -- in
    ...
    branch_pc       : in std_logic_vector(3 downto 0);  -- sig_ex_next_pc / flush pc
    stall_pc        : in std_logic_vector(3 downto 0);  -- pc remains the same as currently is, ie sig_if_curr_pc
    next_pc         : in std_logic_vector(3 downto 0);  -- normal behaviour, ie sig_if_next_pc
...
signal sig_if_next_pc              : std_logic_vector(7 downto 0);
signal sig_if_curr_pc              : std_logic_vector(7 downto 0);
signal sig_one_8b                  : std_logic_vector(7 downto 0);
signal sig_if_pc_carry_out         : std_logic;
signal sig_if_insn                 : std_logic_vector(31 downto 0);
...
signal sig_id_read_data_a          : std_logic_vector(31 downto 0);
signal sig_id_read_data_b          : std_logic_vector(31 downto 0);
signal sig_ex_alu_src_b            : std_logic_vector(31 downto 0);
signal sig_ex_alu_result           : std_logic_vector(31 downto 0); 
signal sig_ex_alu_carry_out        : std_logic;
signal sig_mem_data_mem_out         : std_logic_vector(31 downto 0);

signal sig_pc_next_actual       : std_logic_vector(7 downto 0);
...
signal sig_id_opcode      : std_logic_vector(3 downto 0);
...
signal sig_id_imm4b       : std_logic_vector(3 downto 0);
signal sig_id_imm8b       : std_logic_vector(7 downto 0);
...
signal sig_ex_read_out_1          : std_logic_vector(31 downto 0);
signal sig_ex_read_out_2          : std_logic_vector(31 downto 0);
signal sig_ex_imm32b              : std_logic_vector(31 downto 0);
signal sig_ex_imm8b               : std_logic_vector(7 downto 0);
signal sig_ex_rr_out_1            : std_logic_vector(3 downto 0);
signal sig_ex_rr_out_2            : std_logic_vector(3 downto 0);
signal sig_ex_wr_out              : std_logic_vector(3 downto 0);
signal sig_ex_pc_out              : std_logic_vector(7 downto 0);
...
signal sig_ex_read_data_1             : std_logic_vector(31 downto 0);
signal sig_ex_read_data_2             : std_logic_vector(31 downto 0);

signal sig_mem_alu_res_out         : std_logic_vector(31 downto 0);
signal sig_mem_read_data_out_2     : std_logic_vector(31 downto 0);
signal sig_mem_write_reg_out       : std_logic_vector(3 downto 0);
...
signal sig_wb_write_data  : std_logic_vector(31 downto 0);

signal sig_wb_alu_result_out      : std_logic_vector(31 downto 0);
signal sig_wb_mem_result_out      : std_logic_vector(31 downto 0);
signal sig_wb_write_reg_out       : std_logic_vector(3 downto 0);
signal sig_wb_mem_to_reg          : std_logic;
signal sig_wb_switch_in           : std_logic;
signal sig_wb_led_write           : std_logic;

signal sig_wb_alu_or_mem            : std_logic_vector(31 downto 0);
...
begin
    ...
    port map ( data_in  => sig_id_imm4b,
               data_out => sig_id_imm16b );
    ...
    port map ( reset        => btnL,
               ...
               addr_in      => sig_mem_alu_res_out(3 downto 0),
    ...
    port map ( data_in      => sig_wb_alu_or_mem,
               clk          => clk,
    ...
    mux_final_data_out : mux_2to1_16b
